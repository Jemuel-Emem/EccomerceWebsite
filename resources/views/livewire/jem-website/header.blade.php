    ...
    <nav class=" border-gray-200  dark:bg-gray-800 dark:border-gray-700 bg-blue-700 w-screen">
        <div class=" flex flex-wrap items-center justify-between mx-auto">
          <a href="practice" class="flex items-center">
              ...
              <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Agnes</span>
          </a>
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
            ...
            <li>
            <a href="shop" class="block py-2 text-yellow-500 text-xl hover:text-yellow-100 outl"><i class="ri-shopping-cart-2-fill "></i></a>
            </li>
            <li>
            <a href="shop" class="block py-2 mr-8 text-yellow-500 text-xl hover:text-yellow-100 outl"><i class="ri-store-line"></i></i></a>
            </li>
