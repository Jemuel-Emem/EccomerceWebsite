    ...
    <nav class=" border-gray-200  dark:bg-gray-800 dark:border-gray-700 bg-blue-700 w-screen">
        <div class=" flex flex-wrap items-center justify-between mx-auto">
          <a href="practice" class="flex items-center">
              ...
              <span class="self-center text-xl font-semibold whitespace-nowrap text-light">Agnes</span>
          </a>
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
            ...
            <li>
            <a href="" class="block py-2 text-light text-xl no-underline" style="text-decoration: none;">Order List</a>
            </li>
            <li>
            <a href="" class="block py-2 mr-8 text-light text-xl " style="text-decoration: none;">Sales</a>
            </li>
